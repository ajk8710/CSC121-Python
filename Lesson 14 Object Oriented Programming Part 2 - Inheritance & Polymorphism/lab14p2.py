...
from bill_water import BillWater
from bill_electricity import BillElectricity
...
while choice not in {'1', '2'}:
    choice = input('Enter 1 for water bill or 2 for electricity bill: ')
if choice == '1':
    bill = BillWater(name, address)
else:  # choice == '2'
    bill = BillElectricity(name, address)
